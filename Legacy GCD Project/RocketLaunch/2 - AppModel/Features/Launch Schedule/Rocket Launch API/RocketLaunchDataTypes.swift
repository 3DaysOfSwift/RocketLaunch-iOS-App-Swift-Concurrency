...
struct RocketLaunch: Identifiable, Equatable, Codable {
    let id: String
...
struct LaunchMission: Equatable, Codable {
    let name: String
    let description: String?
}

struct EstimatedLaunchDate: Equatable, Codable {
    let month: Int?
    let day: Int?
    let year: Int?
}

struct LaunchDetails: Equatable, Codable {
    let provider: String?
    let vehicle: String?
    let country: String?
    let site: String?
